...
namespace InfernumMode.Balancing
{
    public static class NPCHPValues
    {
        public static Dictionary<int, int> HPValues => new()
        {
            ...
            [ModContent.NPCType<OldDukeBoss>()] = BossRushEvent.BossRushActive ? 1600000 : 1000000,
            [ModContent.NPCType<DevourerofGodsHead>()] = BossRushEvent.BossRushActive ? 2450000 : 1385500,
            ...
            [ModContent.NPCType<SupremeCalamitas>()] = BossRushEvent.BossRushActive ? -1 : 2989400,
        };
