...
namespace InfernumMode.BehaviorOverrides.AbyssAIs
{
    public class EidolistElectricOrb2 : ModProjectile
    {
        ...
        public override string Texture => "InfernumMode/BehaviorOverrides/AbyssAIs/EidolistElectricOrb";
        ...
        public override bool PreDraw(ref Color lightColor)
        {
            ...
            for (int i = 0; i < LightningCount; i++)
            {
                Vector2 telegraphDirection = (MathHelper.TwoPi * i / LightningCount).ToRotationVector2();
