...
namespace InfernumMode.BehaviorOverrides.AbyssAIs
{
    public class MiniReaperShark : ModProjectile
    {
        ...
        public override bool PreDraw(ref Color lightColor)
        {
            ...
            ScreenSaturationBlurSystem.ThingsToDrawOnTopOfBlur.Add(new(texture, drawPosition, frame, color, Projectile.rotation, frame.Size() * 0.5f, Projectile.scale, direction, 0));
            return false;
        }
