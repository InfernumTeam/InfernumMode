...
namespace InfernumMode.BehaviorOverrides.AbyssAIs
{
    public class MorayEelBehaviorOverride : NPCBehaviorOverride
    {
        ...
        public override bool PreDraw(NPC npc, SpriteBatch spriteBatch, Color lightColor)
        {
            ...
            Texture2D headTexture = ModContent.Request<Texture2D>("InfernumMode/BehaviorOverrides/AbyssAIs/MorayEelHead").Value;
            Texture2D body1Texture = ModContent.Request<Texture2D>("InfernumMode/BehaviorOverrides/AbyssAIs/MorayEelBody1").Value;
            Texture2D body2Texture = ModContent.Request<Texture2D>("InfernumMode/BehaviorOverrides/AbyssAIs/MorayEelBody2").Value;
