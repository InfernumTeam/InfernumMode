...
namespace InfernumMode.BehaviorOverrides.BossAIs.AdultEidolonWyrm
{
    public class AEWHeadBehaviorOverride : NPCBehaviorOverride
    {
        ...
        public override bool PreDraw(NPC npc, SpriteBatch spriteBatch, Color lightColor)
        {
            ...
            ScreenSaturationBlurSystem.ThingsToDrawOnTopOfBlur.Add(new(eyeTexture, drawPosition, null, eyeColor, npc.rotation, eyeTexture.Size() * 0.5f, npc.scale, 0, 0));
        ...
        public static void DrawSegment(NPC npc, Color lightColor)
        {
            ...
            ScreenSaturationBlurSystem.ThingsToDrawOnTopOfBlur.Insert(0, new(glowmaskTexture, drawPosition, npc.frame, npc.GetAlpha(Color.White) * 0.65f, npc.rotation, npc.frame.Size() * 0.5f, npc.scale, 0, 0));
            if (superEnrageFormAestheticInterpolant > 0f)
            {
                ...
                for (int i = 0; i < 10; i++)
                {
                    ...
                    ScreenSaturationBlurSystem.ThingsToDrawOnTopOfBlur.Add(new(texture, drawPosition + drawOffset, npc.frame, wispFormColor, npc.rotation, npc.frame.Size() * 0.5f, npc.scale, 0, 0));
                }
            }
