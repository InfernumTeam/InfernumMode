...
namespace InfernumMode.BehaviorOverrides.BossAIs.AdultEidolonWyrm
{
    public class DivineLightBolt : ModProjectile
    {
        ...
        public override bool PreDraw(ref Color lightColor)
        {
            ...
            ScreenSaturationBlurSystem.ThingsToDrawOnTopOfBlur.Add(new(texture, drawPosition, frame, Color.White * Projectile.Opacity, Projectile.rotation, origin, Projectile.scale, 0, 0));
