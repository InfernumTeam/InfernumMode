...
namespace InfernumMode.BehaviorOverrides.BossAIs.AstrumDeus
{
    public class AstralPlasmaBeam : ModProjectile
    {
        ...
        {
            Color color = new(234, 119, 93);
            color = Color.Lerp(color, new Color(109, 242, 196), ((float)Math.Sin(MathHelper.TwoPi * completionRatio - Main.GlobalTimeWrappedHourly * 1.37f) * 0.5f + 0.5f) * 0.67f);
        ...
        public override bool PreDraw(ref Color lightColor)
        {
            ...
            if (Time >= 2f)
            {
                ...
                BeamDrawer.Draw(points, Projectile.Size * 0.5f + (Main.GlobalTimeWrappedHourly * 1.8f).ToRotationVector2() * 2f - Main.screenPosition, 67);
            }
            return false;
        }
    }
