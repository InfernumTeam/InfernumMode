            ...
            if (Time == 60f)
            {
                ...
                if (Main.netMode != NetmodeID.MultiplayerClient)
                {
                    ...
                    for (int i = 0; i < laserCount; i++)
                    {
                        ...
                        int laser = Projectile.NewProjectile(Projectile.GetSource_FromAI(), Projectile.Center, shootVelocity, InfernumMode.CalamityMod.Find<ModProjectile>("DoGDeath").Type, 85, 0f, Projectile.owner);
