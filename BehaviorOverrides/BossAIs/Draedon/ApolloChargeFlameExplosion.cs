...
namespace InfernumMode.BehaviorOverrides.BossAIs.Draedon
{
	public class ApolloChargeFlameExplosion : ModProjectile
	{
		...
		public override bool CanHitPlayer(Player target) => projectile.Opacity == 1f && projectile.timeLeft < 275f;
		...
		public override void Kill(int timeLeft)
		{
			...
			for (int i = 0; i < 3; i++)
			{
				...
				Utilities.NewProjectileBetter(projectile.Center, sparkVelocity, ModContent.ProjectileType<PlasmaSpark>(), 500, 0f);
			}
		}
