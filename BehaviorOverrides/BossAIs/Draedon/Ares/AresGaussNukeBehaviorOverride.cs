...
namespace InfernumMode.BehaviorOverrides.BossAIs.Draedon.Ares
{
    public class AresGaussNukeBehaviorOverride : NPCBehaviorOverride
    {
        ...
        public override bool PreAI(NPC npc)
        {
            ...
            ref SlotId telegraphSound = ref npc.ModNPC<AresGaussNuke>().TelegraphSoundSlot;
            ...
            if (attackTimer == telegraphTime && !currentlyDisabled)
                telegraphSound = SoundEngine.PlaySound(AresGaussNuke.TelSound with { Volume = 1.6f }, npc.Center);
