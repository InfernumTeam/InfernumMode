...
namespace InfernumMode.BehaviorOverrides.BossAIs.Draedon.Athena
{
    public class PulseLaser : ModProjectile
    {
        ...
        public const float TelegraphTotalTime = 40f;
        public const float TelegraphFadeTime = 15f;
        public const float TelegraphWidth = 1900f;
        public const float LaserVelocity = 8f;
        ...
        public override void SendExtraAI(BinaryWriter writer)
        {
            ...
            writer.Write(TurretOffsetIndex);
        ...
        public override void ReceiveExtraAI(BinaryReader reader)
        {
            ...
            TurretOffsetIndex = reader.ReadInt32();
        ...
        public override void AI()
        {
            ...
            else if (Destination == Vector2.Zero)
            {
                ...
                Projectile.Center = ThingToAttachTo.ModNPC<AthenaNPC>().GetTurretPosition(TurretOffsetIndex);
                ...
                Velocity = (Destination - ThingToAttachTo.Center).SafeNormalize(Vector2.UnitY) * InitialSpeed;
        ...
        public override bool PreDraw(ref Color lightColor)
        {
            ...
            Color colorOuter = Color.Lerp(Color.Fuchsia, Color.White, TelegraphDelay / TelegraphTotalTime * 0.4f);
