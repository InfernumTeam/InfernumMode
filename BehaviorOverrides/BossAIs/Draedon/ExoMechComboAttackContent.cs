...
namespace InfernumMode.BehaviorOverrides.BossAIs.Draedon
{
    public static class ExoMechComboAttackContent
    {
        ...
        public static bool ShouldSelectComboAttack(NPC npc, out ExoMechComboAttackType newAttack)
        {
            ...
            if (aresAndTwins)
            {
                newAttack = Utils.SelectRandom(Main.rand, ExoMechComboAttackType.AresTwins_PressureLaser, ExoMechComboAttackType.AresTwins_DualLaserCharges);
        ...
        public static bool DoBehavior_AresTwins_DualLaserCharges(NPC npc, Player target, float twinsHoverSide, ref float attackTimer, ref float frame)
        {
            ...
            if (npc.type == ModContent.NPCType<AresBody>())
            {
                ...
                if (deathraysHaveBeenFired)
                {
                    ...
                    float deathraySpeed = Utils.InverseLerp(0f, 180f, laserbeamRelativeTime, true) * MathHelper.TwoPi / 270f;
