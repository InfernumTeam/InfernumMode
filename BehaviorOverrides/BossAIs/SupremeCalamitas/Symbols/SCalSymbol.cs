...
namespace InfernumMode.BehaviorOverrides.BossAIs.SupremeCalamitas.Symbols
{
    public class SCalSymbol : ModProjectile, IAdditiveDrawer
    {
        ...
        {
            Texture2D tex = ModContent.Request<Texture2D>($"InfernumMode/BehaviorOverrides/BossAIs/SupremeCalamitas/Symbols/{AlchemicalNames[Projectile.identity % 8]}").Value;
