...
namespace InfernumMode.Content.BehaviorOverrides.BossAIs.BrimstoneElemental
{
    public class RedFlameTelegraph : ModProjectile
    {
        ...
        public override bool PreDraw(ref Color lightColor)
        {
            ...
            float opacity = (float)Math.Pow(CalamityUtils.Convert01To010(Time / TelegraphTime), 0.4);
            ...
            laserScopeEffect.Parameters["laserWidth"].SetValue(0.003f + (float)Math.Pow(opacity, 4D) * (MathF.Sin(Main.GlobalTimeWrappedHourly * 3f) * 0.001f + 0.001f));
