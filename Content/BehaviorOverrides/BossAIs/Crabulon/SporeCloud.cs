        ...
        public override bool PreDraw(ref Color lightColor)
        {
            ...
            switch ((int)Projectile.ai[0])
            {
                case 0:
                    break;
                case 1:
                    texture = ModContent.Request<Texture2D>("InfernumMode/Content/BehaviorOverrides/BossAIs/Crabulon/SporeCloud2").Value;
                    break;
                case 2:
                    texture = ModContent.Request<Texture2D>("InfernumMode/Content/BehaviorOverrides/BossAIs/Crabulon/SporeCloud3").Value;
                    break;
                default:
                    break;
            }
