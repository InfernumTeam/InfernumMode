...
namespace InfernumMode.Content.BehaviorOverrides.BossAIs.DesertScourge
{
    public class DesertScourgeTailBigBehaviorOverride : NPCBehaviorOverride
    {
        ...
        {
            spriteBatch.Draw(BossTextureRegistry.DesertScourgeTail.Value, npc.Center - Main.screenPosition, npc.frame, npc.GetAlpha(lightColor), npc.rotation, npc.frame.Size() * 0.5f, npc.scale, SpriteEffects.None, 0f);
            return false;
        }
    }
}
