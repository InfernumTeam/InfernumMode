...
namespace InfernumMode.Content.BehaviorOverrides.BossAIs.Draedon.Thanatos
{
    public class OverloadBoom : BaseWaveExplosionProjectile
    {
        ...
        {
            float baseShakePower = MathHelper.Lerp(0.45f, 3f, MathF.Sin(MathHelper.Pi * lifetimeCompletionRatio));
        ...
        {
            Color exoColor = CalamityUtils.MulticolorLerp(MathF.Sin(lifetimeCompletionRatio * MathHelper.Pi * 3f) * 0.5f + 0.5f, CalamityUtils.ExoPalette);
