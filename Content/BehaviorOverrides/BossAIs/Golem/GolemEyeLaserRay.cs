...
namespace InfernumMode.Content.BehaviorOverrides.BossAIs.Golem
{
    public class GolemEyeLaserRay : BaseLaserbeamProjectile
    {
        ...
        public override Texture2D LaserBeginTexture => ModContent.Request<Texture2D>("InfernumMode/Assets/ExtraTextures/Lasers/GolemHeadBeamBegin", AssetRequestMode.ImmediateLoad).Value;
        public override Texture2D LaserMiddleTexture => ModContent.Request<Texture2D>("InfernumMode/Assets/ExtraTextures/Lasers/GolemHeadBeamMid", AssetRequestMode.ImmediateLoad).Value;
        public override Texture2D LaserEndTexture => ModContent.Request<Texture2D>("InfernumMode/Assets/ExtraTextures/Lasers/GolemHeadBeamEnd", AssetRequestMode.ImmediateLoad).Value;
