...
namespace InfernumMode.Content.BehaviorOverrides.BossAIs.MoonLord
{
    public class MoonLordLeechBehaviorOverride : ProjectileBehaviorOverride
    {
        ...
        public override bool PreDraw(Projectile projectile, SpriteBatch spriteBatch, Color lightColor)
        {
            ...
            Texture2D bodyTexture = ModContent.Request<Texture2D>("InfernumMode/Content/BehaviorOverrides/BossAIs/MoonLord/CustomSprites/LeechBody").Value;
            Texture2D penultimateBodyTexture = ModContent.Request<Texture2D>("InfernumMode/Content/BehaviorOverrides/BossAIs/MoonLord/CustomSprites/LeechBodyPenumltimate").Value;
