...
namespace InfernumMode.Content.BehaviorOverrides.BossAIs.PlaguebringerGoliath
{
    public class BuilderDroneSmall : ModNPC
    {
        ...
        public override string Texture => "InfernumMode/Content/BehaviorOverrides/BossAIs/PlaguebringerGoliath/SmallDrone";
        ...
        public override void AI()
        {
            ...
            continousHoverPosition += (NPC.whoAmI * 1.58436f).ToRotationVector2() * Cos(GeneralTimer / 17f) * 42f;
