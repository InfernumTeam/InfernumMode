    ...
    public class CrystalPillar : ModProjectile
    {
        ...
        public override bool PreDraw(ref Color lightColor)
        {
            ...
            if (Time < 60f)
            {
                ...
                Main.spriteBatch.DrawLineBetter(Projectile.Top + lineOffset, Projectile.Top - direction * (-MaxPillarHeight + 240f) + lineOffset, Color.LightGoldenrodYellow, scale);
            }

            Texture2D tipTexture = ModContent.Request<Texture2D>(Texture).Value;
            Texture2D pillarTexture = ModContent.Request<Texture2D>("InfernumMode/Content/BehaviorOverrides/BossAIs/Providence/CrystalPillarBodyPiece").Value;
