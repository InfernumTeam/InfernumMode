...
namespace InfernumMode.Content.Tiles
{
    public class InfernalChaliceTile : ModTile
    {
        ...
        public override bool PreDraw(int i, int j, SpriteBatch spriteBatch)
        {
            ...
            Texture2D texture = ModContent.Request<Texture2D>("InfernumMode/Content/Tiles/InfernalChaliceTileAnimation").Value;
            Texture2D glowmask = ModContent.Request<Texture2D>("InfernumMode/Content/Tiles/InfernalChaliceTileAnimation").Value;
