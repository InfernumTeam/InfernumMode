...
namespace InfernumMode.FuckYouModeAIs.BoC
{
    public class BoCAIClass
    {
		...
		[OverrideAppliesTo(NPCID.BrainofCthulhu, typeof(BoCAIClass), "BoCAI", EntityOverrideContext.NPCAI)]
        public static bool BoCAI(NPC npc)
        {
        ...
        [OverrideAppliesTo(NPCID.Creeper, typeof(BoCAIClass), "CreeperAI", EntityOverrideContext.NPCAI)]
        public static bool CreeperAI(NPC npc)
        {
            ...
            if (ownerAttackState == BoCAttackState.CreeperBloodDripping)
            {
                ...
                if (attackTimer > 90f && eligableToFire && attackTimer % 55f == 54f && npc.alpha <= 80)
                {
        ...
        [OverrideAppliesTo(NPCID.BrainofCthulhu, typeof(BoCAIClass), "BoCPreDraw", EntityOverrideContext.NPCPreDraw)]
        public static bool BoCPreDraw(NPC npc, SpriteBatch spriteBatch, Color drawColor)
        {
            ...
            drawInstance(npc.Center, npc.GetAlpha(drawColor), npc.scale);
            return false;
        }

        [OverrideAppliesTo(NPCID.Creeper, typeof(BoCAIClass), "CreeperPreDraw", EntityOverrideContext.NPCPreDraw)]
        public static bool CreeperPreDraw(NPC npc, SpriteBatch spriteBatch, Color drawColor)
        {
            Texture2D texture = Main.npcTexture[npc.type];
