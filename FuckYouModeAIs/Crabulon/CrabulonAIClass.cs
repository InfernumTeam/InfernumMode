...
namespace InfernumMode.FuckYouModeAIs.Crabulon
{
    public class CrabulonAIClass
    {
		...
		[OverrideAppliesTo("CrabulonIdle", typeof(CrabulonAIClass), "CrabulonAI", EntityOverrideContext.NPCAI)]
        public static bool CrabulonAI(NPC npc)
        {
