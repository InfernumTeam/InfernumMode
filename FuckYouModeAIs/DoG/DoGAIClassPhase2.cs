...
namespace InfernumMode.FuckYouModeAIs.DoG
{
	public class DoGAIClassPhase2
    {
        ...
        [OverrideAppliesTo("DevourerofGodsHeadS", typeof(DoGAIClassPhase2), "DoGP2Head", EntityOverrideContext.NPCAI)]
        public static bool DoGP2Head(NPC npc)
        {
        ...
        [OverrideAppliesTo("DevourerofGodsHeadS", typeof(DoGAIClassPhase2), "DoGP2PreDraw", EntityOverrideContext.NPCPreDraw)]
        public static bool DoGP2PreDraw(NPC npc, SpriteBatch spriteBatch, Color drawColor)
        {
            ...
            for (int i = -1; i <= 1; i += 2)
            {
                ...
                spriteBatch.Draw(jawTexture, jawPosition, null, npc.GetAlpha(drawColor), npc.rotation + jawRotation * i, jawOrigin, npc.scale, jawSpriteEffect, 0f);
            }
