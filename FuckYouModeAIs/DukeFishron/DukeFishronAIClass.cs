...
{
	public class DukeFishronAIClass
    {
        #region Enumerations
		...
		#region AI
		[OverrideAppliesTo(NPCID.DukeFishron, typeof(DukeFishronAIClass), "FishronAI", EntityOverrideContext.NPCAI)]
        public static bool FishronAI(NPC npc)
        {
        ...
        [OverrideAppliesTo(NPCID.DukeFishron, typeof(DukeFishronAIClass), "FishronFindFrame", EntityOverrideContext.NPCFindFrame)]
        public static void FishronFindFrame(NPC npc, int frameHeight)
        {
        ...
        [OverrideAppliesTo(NPCID.DukeFishron, typeof(DukeFishronAIClass), "FishronPreDraw", EntityOverrideContext.NPCPreDraw)]
        public static bool FishronPreDraw(NPC npc, SpriteBatch spriteBatch, Color lightColor)
        {
