...
{
	public class ProfanedGuardianAIClass
    {
		#region AI

		#region Offensive Guardian
		...
		[OverrideAppliesTo("ProfanedGuardianBoss", typeof(ProfanedGuardianAIClass), "OffensiveGuardianAI", EntityOverrideContext.NPCAI)]
        public static bool OffensiveGuardianAI(NPC npc)
        {
        ...
        #region Defensive Guardian
        [OverrideAppliesTo("ProfanedGuardianBoss2", typeof(ProfanedGuardianAIClass), "DefensiveGuardianAI", EntityOverrideContext.NPCAI)]
        public static bool DefensiveGuardianAI(NPC npc)
        {
        ...
        #region Crystal Guardian

        [OverrideAppliesTo("ProfanedGuardianBoss3", typeof(ProfanedGuardianAIClass), "CrystalGuardianAI", EntityOverrideContext.NPCAI)]
        public static bool CrystalGuardianAI(NPC npc)
        {
            if (!Main.npc.IndexInRange(CalamityGlobalNPC.doughnutBoss) || !Main.npc[CalamityGlobalNPC.doughnutBoss].active)
            {
                npc.active = false;
