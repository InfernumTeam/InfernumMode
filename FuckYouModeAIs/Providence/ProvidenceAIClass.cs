...
using InfernumMode.FuckYouModeAIs.Yharon;
...
{
	public class ProvidenceAIClass
    {
        #region Enumerations
		...
		[OverrideAppliesTo("Providence", typeof(ProvidenceAIClass), "ProvidenceAI", EntityOverrideContext.NPCAI)]
        public static bool ProvidenceAI(NPC npc)
		{
		...
		[OverrideAppliesTo("Providence", typeof(ProvidenceAIClass), "ProvidenceFindFrame", EntityOverrideContext.NPCFindFrame)]
		public static void ProvidenceFindFrame(NPC npc, int frameHeight)
		{
			ref float drawState = ref npc.localAI[0];
		...
		[OverrideAppliesTo("Providence", typeof(ProvidenceAIClass), "ProvidencePreDraw", EntityOverrideContext.NPCPreDraw)]
        public static bool ProvidencePreDraw(NPC npc, SpriteBatch spriteBatch, Color lightColor)
		{
			...
			void drawProvidenceInstance(Vector2 baseDrawPosition, int frameOffset, Color baseDrawColor)
			{
				...
				Texture2D fatCrystalTexture = ModContent.GetTexture("InfernumMode/FuckYouModeAIs/Providence/ProvidenceCrystal");
