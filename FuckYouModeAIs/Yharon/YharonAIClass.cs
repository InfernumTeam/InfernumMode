...
namespace InfernumMode.FuckYouModeAIs.Yharon
{
	public class YharonAIClass
    {
        ...
        #region Yharon
        [OverrideAppliesTo("Yharon", typeof(YharonAIClass), "YharonAI", EntityOverrideContext.NPCAI)]
        public static bool YharonAI(NPC npc)
        {
        ...
        #region Detonating Flames

        [OverrideAppliesTo("DetonatingFlare", typeof(YharonAIClass), "DetonatingFlareType1", EntityOverrideContext.NPCAI)]
        public static bool DetonatingFlareType1(NPC npc)
        {
            npc.alpha -= 3;
            Player player = Main.player[npc.target];
            if (npc.ai[0] == 0f)
        ...
        [OverrideAppliesTo("DetonatingFlare", typeof(YharonAIClass), "DetonatingFlameSetDefaults", EntityOverrideContext.NPCSetDefaults)]
        public static void DetonatingFlameSetDefaults(NPC npc)
        {
            npc.damage = 400;
            npc.lifeMax = 19000;
        ...
        [OverrideAppliesTo("Yharon", typeof(YharonAIClass), "YharonFindFrame", EntityOverrideContext.NPCFindFrame)]
        public static void YharonFindFrame(NPC npc, int frameHeight)
        {
        ...
        [OverrideAppliesTo("Yharon", typeof(YharonAIClass), "YharonPreDraw", EntityOverrideContext.NPCPreDraw)]
        public static bool YharonPreDraw(NPC npc, SpriteBatch spriteBatch, Color lightColor)
        {
