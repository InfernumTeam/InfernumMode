    ...
    public partial class GlobalItems : GlobalItem
    {
        public override void ModifyItemLoot(Item item, ItemLoot loot)
        {
            ...
            if (item.type == ItemID.EaterOfWorldsBossBag)
            {
                ...
                eowInfLCR.Add(ItemID.DemoniteOre, 1, 125);
                eowInfLCR.Add(ItemID.ShadowScale, 1, 50);
            }
            if (item.type == ItemID.BrainOfCthulhuBossBag)
            {
                ...
                bocInfLCR.Add(ItemID.CrimtaneOre, 1, 125);
                bocInfLCR.Add(ItemID.TissueSample, 1, 50);
            }
            ...
            if (item.type == ItemID.QueenSlimeBossBag)
            {
                ...
                qsInfLCR.Add(ItemID.SoulofLight, 1, 30);
            }
            ...
            if (item.type == ItemID.SkeletronPrimeBossBag)
            {
                ...
                primeInfLCR.Add(ItemID.SoulofFright, 1, 30);
            }
            ...
            if (item.type == ModContent.ItemType<CalamitasBag>())
            {
                ...
                cloneInfLCR.Add(ModContent.ItemType<AshesofCalamity>(), 1, 25);
            }
            ...
            if (item.type == ItemID.PlanteraBossBag)
            {
                ...
                plantInfLCR.Add(ModContent.ItemType<LivingShard>(), 1, 25);
            }
            ...
            if (item.type == ModContent.ItemType<PlaguebringerGoliathBag>())
            {
                ...
                pbgInfLCR.Add(ModContent.ItemType<InfectedArmorPlating>(), 1, 25);
            }
            ...
            if (item.type == ModContent.ItemType<AstrumDeusBag>())
            {
                ...
                deusInfLCR.Add(ItemID.FragmentSolar, 1, 60);
                deusInfLCR.Add(ItemID.FragmentStardust, 1, 60);
                deusInfLCR.Add(ItemID.FragmentNebula, 1, 60);
                deusInfLCR.Add(ItemID.FragmentVortex, 1, 60);
            }
            ...
            if (item.type == ItemID.MoonLordBossBag)
            {
                ...
                mlInfLCR.Add(ItemID.LunarOre, 1, 600);
            }
            ...
            if (item.type == ModContent.ItemType<DragonfollyBag>())
            {
                ...
                follyInfLCR.Add(ModContent.ItemType<EffulgentFeather>(), 1, 25);
            }
            ...
            if (item.type == ModContent.ItemType<ProvidenceBag>())
            {
                ...
                provInfLCR.Add(ModContent.ItemType<DivineGeode>(), 1, 30);
            }
            ...
            if (item.type == ModContent.ItemType<StormWeaverBag>())
            {
                ...
                swInfLCR.Add(ModContent.ItemType<ArmoredShell>(), 1, 8);
            }
            if (item.type == ModContent.ItemType<CeaselessVoidBag>())
            {
                ...
                voidInfLCR.Add(ModContent.ItemType<DarkPlasma>(), 1, 8);
            }
            if (item.type == ModContent.ItemType<SignusBag>())
            {
                ...
                signusInfLCR.Add(ModContent.ItemType<TwistingNether>(), 1, 8);
            }
            ...
            if (item.type == ModContent.ItemType<PolterghastBag>())
            {
                ...
                polterInfLCR.Add(ModContent.ItemType<RuinousSoul>(), 1, 25);
            }
            ...
            if (item.type == ModContent.ItemType<DevourerofGodsBag>())
            {
                ...
                dogInfLCR.Add(ModContent.ItemType<CosmiliteBar>(), 1, 400);
            }
            ...
            if (item.type == ModContent.ItemType<YharonBag>())
            {
                ...
                yharonInfLCR.Add(ModContent.ItemType<YharonSoulFragment>(), 1, 35);
            }
            ...
            if (item.type == ModContent.ItemType<DraedonBag>())
            {
                ...
                draedonInfLCR.Add(ModContent.ItemType<ExoPrism>(), 1, 40);
            }
            ...
            if (item.type == ModContent.ItemType<SupremeCalamitasCoffer>())
            {
                ...
                calInfLCR.Add(ModContent.ItemType<AshesofAnnihilation>(), 1, 40);
            }
        }
    }
}
