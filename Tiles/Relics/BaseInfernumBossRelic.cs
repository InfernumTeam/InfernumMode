...
namespace InfernumMode.Tiles.Relics
{
    public abstract class BaseInfernumBossRelic : ModTile
    {
        ...
        public override string Texture => "InfernumMode/Tiles/Relics/Pedestal";
        public static string DrawTexture => "InfernumMode/Tiles/Relics/Pedestal";
        public static string RelicBaseGlowTextureName => "InfernumMode/Tiles/Relics/PedestalGlow";
